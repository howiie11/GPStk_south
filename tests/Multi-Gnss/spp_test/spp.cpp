...
// The popurse of this file is to perform Standard Point Positioning(SPP)
// of Multi-GNSS system.
// Author Lei Zhao, WHU, 2016/07/21 ~ 2016/07/ 
//==============================================================================
...
int main(void)
{
		...
		MOPSTropModel mopsTM( nominalPos.getAltitude(), 
			...
			// Model observable
		ModelObs model(nominalPos, ionoStore, mopsTM, r3EphStore, TypeID::P2);
		...
		myFilter.setFilteredType(TypeID::P2);
			...
			// are present
		RequireObservables requireObs(TypeID::P2);
