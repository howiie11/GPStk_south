...
/**
 * @file PositioningResultsHeader.hpp
 * Encapsulate header of PositioningResults file data, including I/O
 */
...
#ifndef GPSTK_POSITIONINGRESULTSHEADER_HPP
#define GPSTK_POSITIONINGRESULTSHEADER_HPP
...
namespace gpstk
{
   ...
   //@{
      ...
      /// This class models the header for a PositioningResults file.
      ///
      /// @note A valid header MUST be read before data can be read from an PositioningResults file
      /// because the header contains the file version or format. The version in
      /// this Header is used by PositioningResultsStream to determine the format of output PositioningResultsData.
      ///
      /// @sa gpstk::PositioningResultsStream and gpstk::PositioningResultsData for more information.
   class PositioningResultsHeader : public PositioningResultsBase
   {
   public:

         /// Supported PositioningResults versions (file formats) : 'a' 'b' or 'c'
         /// See the PositioningResults format definition documents.
      enum Version
      {
         undefined,        ///< Unknown or undefined PositioningResults file format
         SP3a,             ///< SP3 version a
         ...
         /// constructor
      PositioningResultsHeader() : version(undefined), numberOfEpochs(0),
                    timeSystem(TimeSystem::Any)
                    {}

         /// destructor
      virtual ~PositioningResultsHeader() {}
      ...
      { return timeSystem.asString(); };
         ...
         /// PositioningResultsHeader is a "header" so this function always returns true.
      ...
      friend class PositioningResultsData;
   ...
   protected:
      ...
      virtual void reallyPutRecord(FFStream& s) const 
         ...
         /// This function retrieves the PositioningResults header from the given FFStream.
   ...
   }; // end class PositioningResultsHeader
