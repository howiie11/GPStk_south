...
namespace gpstk
{
      ...
      std::string MWCSDetector2MGEX::getClassName() const
      { return "MWCSDetector2MGEX"; }
       ...
       */
      MWCSDetector2MGEX::MWCSDetector2MGEX( const double& mLambdas,
                                 const double& dtMax,
                                 const bool& use )
       ...
       */
      satTypeValueMap& MWCSDetector2MGEX::Process( const CommonTime& epoch,
...
//                        (*it).second[resultType2] = (*it).second[resultType1];
      ...
      }  // End of method 'MWCSDetector2MGEX::Process()'
       ...
       */
      MWCSDetector2MGEX& MWCSDetector2MGEX::setDeltaTMax(const double& maxDelta)
      {
      ...
      }  // End of method 'MWCSDetector2MGEX::setDeltaTMax()'
       ...
       *                     wavelenghts).
       */
      MWCSDetector2MGEX& MWCSDetector2MGEX::setMaxNumLambdas(const double& mLambdas)
      {
      ...
      }  // End of method 'MWCSDetector2MGEX::setMaxNumLambdas()'
       ...
       * @param gData    Data object holding the data.
       */
      gnssRinex& MWCSDetector2MGEX::Process(gnssRinex& gData)
      throw(ProcessingException)
      {
       ...
       */
      double MWCSDetector2MGEX::getDetection( const CommonTime& epoch,
                                        const SatID& sat,
                                        typeValueMap& tvMap,
                                        const short& epochflag,
                                        const double& mw,
                                        const bool& lliCS )
      {
            ...
            double lambdaLimit(0.0);
				if( sat.system == SatID::systemGPS )
				{
					lambdaLimit = maxNumLambdas*WL_WAVELENGTH_GPS;
				}
				else if( sat.system == SatID::systemGalileo )
				{
					lambdaLimit = maxNumLambdas*WL_WAVELENGTH_GAL_L1L5;
				}
				else {
...
//            }
      ...
      }  // End of method 'MWCSDetector2MGEX::getDetection()'
