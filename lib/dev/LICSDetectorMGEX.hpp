...
/**
 * @file LICSDetectorMGEX.hpp
 * This is a class to detect cycle slips using LI observables.
 */

#ifndef GPSTK_LICSDETECTORMGEX_HPP
#define GPSTK_LICSDETECTORMGEX_HPP
...
namespace gpstk
{
       ...
       * @endcode
       *
       * The "LICSDetectorMGEX" object will visit every satellite in the GNSS data
       ...
       *
       */
   class LICSDetectorMGEX : public ProcessingClass
   {
   public:

         /// Default constructor, setting default parameters.
      LICSDetectorMGEX() : obsType(TypeID::LI), lliType1(TypeID::LLI1),
                       lliType2(TypeID::LLI2), lliType5(TypeID::LLI5),
							  lliType6(TypeID::LLI6), lliType7(TypeID::LLI7),
							  lliType8(TypeID::LLI8),
      ...
      { };
          ...
          */
      LICSDetectorMGEX( const double& mThr,
                    const double& drift,
      ...
      { return deltaTMax; };
          ...
          */
      virtual LICSDetectorMGEX& setDeltaTMax(const double& maxDelta);
      ...
      { return minThreshold; };
          ...
          *                meters.
          */
      virtual LICSDetectorMGEX& setMinThreshold(const double& mThr);
      ...
      { return LIDrift; };
          ...
          * @param drift     LI combination limit drift, in meters/second.
          */
      virtual LICSDetectorMGEX& setLIDrift(const double& drift);
      ...
      { return useLLI; };
          ...
          */
      virtual LICSDetectorMGEX& setUseLLI(const bool& use)
