...
namespace gpstk
{
   ...
   std::string LICSDetectorMGEX::getClassName() const
   { return "LICSDetectorMGEX"; }
       ...
       */
   LICSDetectorMGEX::LICSDetectorMGEX( const double& mThr,
                               const double& drift,
                               const double& dtMax,
                               const bool& use )
        ...
        resultType1(TypeID::CSL1), resultType2(TypeID::CSL2), useLLI(use)
   {
       ...
       */
   satTypeValueMap& LICSDetectorMGEX::Process( const CommonTime& epoch,
...
//            (*it).second[resultType2] = (*it).second[resultType1];
   ...
   }  // End of method 'LICSDetectorMGEX::Process()'
       ...
       */
   LICSDetectorMGEX& LICSDetectorMGEX::setDeltaTMax(const double& maxDelta)
   {
   ...
   }  // End of method 'LICSDetectorMGEX::setDeltaTMax()'
       ...
       *                meters.
       */
   LICSDetectorMGEX& LICSDetectorMGEX::setMinThreshold(const double& mThr)
   {
   ...
   }  // End of method 'LICSDetectorMGEX::setMinThreshold()'
       ...
       * @param drift     LI combination limit drift, in meters/second.
       */
   LICSDetectorMGEX& LICSDetectorMGEX::setLIDrift(const double& drift)
   {
   ...
   }  // End of method 'LICSDetectorMGEX::setLIDrift()'
       ...
       * @param gData    Data object holding the data.
       */
   gnssRinex& LICSDetectorMGEX::Process(gnssRinex& gData)
      throw(ProcessingException)
   {
       ...
       */
   double LICSDetectorMGEX::getDetection( const CommonTime& epoch,
                                      const SatID& sat,
                                      typeValueMap& tvMap,
                                      const short& epochflag,
                                      const double& li,
...
//           (tempLLI2==1.0) ||
   ...
   }  // End of method 'LICSDetectorMGEX::getDetection()'
