...
namespace gpstk
{
   ...
   public:
      ...
      gnssLinearCombination pdeltaPrefitGPS;
      ...
      gnssLinearCombination ldeltaPrefitGPS;
      ...
      gnssLinearCombination mwubbenaPrefitGPS;

			// For Galileo system, only E1 and E5a freq are considered 
      gnssLinearCombination mwubbenaPrefitGalileo;
