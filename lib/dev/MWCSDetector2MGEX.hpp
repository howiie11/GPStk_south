...
/**
 * @file MWCSDetector2MGEX.hpp
 * This is a class to detect cycle slips using the Melbourne-Wubbena
 * combination.
 */

#ifndef GPSTK_MWCSDETECTOR2MGEX_HPP
#define GPSTK_MWCSDETECTOR2MGEX_HPP
...
namespace gpstk
{
       ...
       * @endcode
       *
       * The "MWCSDetector2MGEX" object will visit every satellite in the GNSS data
       ...
       *
       */
      class MWCSDetector2MGEX : public ProcessingClass
      {
      public:
            
            /// Default constructor, setting default parameters.
            MWCSDetector2MGEX() : obsType(TypeID::MWubbena), lliType1(TypeID::LLI1),
             ...
             */
            MWCSDetector2MGEX( const double& mLambdas,
             ...
             */
            virtual MWCSDetector2MGEX& setDeltaTMax(const double& maxDelta);
             ...
             *                     wavelenghts).
             */
            virtual MWCSDetector2MGEX& setMaxNumLambdas(const double& mLambdas);
             ...
             */
            virtual MWCSDetector2MGEX& setUseLLI(const bool& use)
