#pragma ident "$Id: CorrectUPDsMGEX.hpp 2475 2012-08-10 02:53:06Z shjzhang $"
...
#ifndef GPSTK_CORRECT_UPDELAYSMGEX_HPP
#define GPSTK_CORRECT_UPDELAYSMGEX_HPP
...
namespace gpstk
{
   ...
   using namespace std;
       ...
       * @endcode
       *
       * The "CorrectUPDsMGEX" object will visit every satellite in the
       ...
       *
       */
   class CorrectUPDsMGEX : public ProcessingClass
   {
   public:
      ...
      { setIndex(); };
          ...
          */
      CorrectUPDsMGEX( RinexUPDStore& updStore )
         : pUPDStore(&updStore)
      { setIndex(); };
