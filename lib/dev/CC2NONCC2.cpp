...
//				}  // End of ' if( copyC1ToP1 ) '
               // Copy C1 to P1
				...
				{
//						// Find C1 first 
					typeValueMap::iterator iterC1 = it->second.find(TypeID::C1);
//					if( iterC1 == (it->second).end() )
//					{
//							// There is no C1
//							// delete this sat
//						satRejectedSet.insert(it->first);
...
//					}
					...
					typeValueMap::iterator iter = it->second.find( TypeID::P1 );
					if( iter == (it->second).end() && iterC1 != (it->second).end() )
					{
							// Copy here
						it->second[TypeID::P1] = it->second[TypeID::C1]; 
					}
					...
					{
						if( (*iter).second == 0.0 && iterC1 != (it->second).end() )
						{
							it->second[TypeID::P1] = it->second[TypeID::C1];
						}
					}
               ...
               // Copy C2 to P2
				...
				{
//						// Find C2 first 
					typeValueMap::iterator iterC2 = it->second.find(TypeID::C2);
//					if( iterC2 == (it->second).end() )
//					{
//							// There is no C2
//							// delete this sat
//						satRejectedSet.insert(it->first);
...
//					}
					...
					typeValueMap::iterator iter = it->second.find( TypeID::P2 );
					if( iter == (it->second).end() && iterC2 != (it->second).end() )
					{
							// Copy here
						it->second[TypeID::P2] = it->second[TypeID::C2]; 
					}
					...
					{
						if( (*iter).second == 0.0 &&  iterC2 != (it->second).end() )
						{
							it->second[TypeID::P2] = it->second[TypeID::C2];
						}
					}
