#pragma ident "$Id: SolverPPPARMGEX.cpp 2645 2012-11-05 03:23:24Z shjzhang $"

/**
 * @file SolverPPPARMGEX.cpp
...
namespace gpstk
{
   ...
   int SolverPPPARMGEX::classIndex = 9300000;

      // Debug level for print out information
   int SolverPPPARMGEX::debugLevel = 0;

      // Returns an index identifying this object.
   int SolverPPPARMGEX::getIndex() const
   { return index; }


      // Returns a string identifying this object.
   std::string SolverPPPARMGEX::getClassName() const
   { return "SolverPPPARMGEX"; }
       ...
       */
   SolverPPPARMGEX::SolverPPPARMGEX(bool useNEU )
   ...
   }  // End of 'SolverPPPARMGEX::SolverPPPARMGEX()'



      // Initializing method.
   void SolverPPPARMGEX::Init(void)
   {
   ...
   }  // End of method 'SolverPPPARMGEX::Init()'
       ...
       */
   gnssSatTypeValue& SolverPPPARMGEX::Process(gnssSatTypeValue& gData)
      throw(ProcessingException, SVNumException)
   {
   ...
   }  // End of method 'SolverPPPARMGEX::Process()'
       ...
       * @param gData     Data object holding the data.
       */
   gnssRinex& SolverPPPARMGEX::Process(gnssRinex& gData)
      throw(ProcessingException, SVNumException)
   {
       ...
       * @param gData    Data object holding the data.
       */
   gnssRinex& SolverPPPARMGEX::preCompute( gnssRinex& gData )
      throw(ProcessingException, SVNumException)
   {
...
//                = -0.861918400322;
					...
					// Accommadation for muti-gnss
				if( (*itSat).system == SatID::systemGPS )
				{
						// ambLC are listed after ( srcIndexedTypes )
					hMatrix( count1 +   numCurrentSV, numVar + count1 ) 
						 = -0.106953378142;
				...
				if( (*itSat).system == SatID::systemGalileo )
				{
						// ambLC are listed after ( srcIndexedTypes )
					hMatrix( count1 +   numCurrentSV, numVar + count1 ) 
						 = -1*LC_WAVELENGTH_GAL_L1L5;

						// ambWL are listed after ( srcIndexedTypes + ambLC )
					hMatrix( count1 + 2*numCurrentSV, numVar + numCurrentSV + count1 ) 
						= -1*WL_WAVELENGTH_GAL_L1L5;	
				}
         ...
         if(firstTime)
         {
            ...
            for( int i=1; i<4; i++ )
            {
               //initialErrorCovariance(i,i) = 100.0;       // (1.0 m)**2
						...
						// The settings should be consistent with 
						// that of 'SolverPPPMGEX'
               initialErrorCovariance(i,i) = 10000.0;       // (100.0 m)**2
            }
...
//               }
					...
					for( int i=1; i<4; i++ )
					{
						currentErrorCov(i,i) = 10000.0;       // (1.0 m)**2
					}

					currentErrorCov(4,4) = 9.0e10;
					currentErrorCov(5,5) = 9.0e10;
					currentErrorCov(6,6) = 9.0e10;
   ...
   }  // End of method 'SolverPPPARMGEX::preCompute()'
      ...
      //
   gnssRinex& SolverPPPARMGEX::Compute( gnssRinex& gData )
      throw(InvalidSolver)
   {
   ...
   }  // End of method 'SolverPPPARMGEX::Compute()'
      ...
      // @param gData    Data object holding the data.
      //
   int SolverPPPARMGEX::TimeUpdate( const Matrix<double>& phiMatrix,
...
of qMatrix");
   ...
   }  // End of method 'SolverPPPARMGEX::TimeUpdate()'


   gnssRinex& SolverPPPARMGEX::AmbiguityConstr( gnssRinex& gData )
      ...
      try
      {
              ...
              ++itSat )
         {
	            ...
	            if( ambWLFixedMap.find( (*itSat) ) != ambWLFixedMap.end()  )
	            {
	                   // ambiguity
	                ambL1Map[(*itSat)] 
	                    = ambLCMap[(*itSat)] - factor2_GAL*ambWLFixedMap[(*itSat)];
				...
				{
					Exception e("Unsupported system");
					GPSTK_THROW(e);
				}
         }
...
//         datumLCMap[refSat] = ambL1FixedMap[refSat] + cw*ambWLFixedMap[refSat];
			if( refSat.system == SatID::systemGPS )
			{
				datumLCMap[refSat] = ambL1FixedMap[refSat] + cw*ambWLFixedMap[refSat];	
			}
			else if( refSat.system == SatID::systemGalileo )
			{
				datumLCMap[refSat] = ambL1FixedMap[refSat] + factor2_GAL*ambWLFixedMap[refSat];	
			}
			else 
			{
					Exception e("Unsupported system");
   ...
   }  // End of method 'SolverPPPARMGEX::AmbiguityConstr()'



      // Now, fix all the ambiguities to integers 
   gnssRinex& SolverPPPARMGEX::AmbiguityFixing( gnssRinex& gData )
      throw(ProcessingException)
   {
                           ...
                           ambL1FixedMap[(*itSat)] = ambL1Fixed(c1);
                              ...
                              // Fixed LC ambiguities
									...
									else if( sat.system == SatID::systemGalileo )
									{
										...
										ambLCFixedMap[(*itSat)]
											 = ambL1FixedMap[(*itSat)] + factor2_GAL*ambWLFixedMap[(*itSat)];
									}
									else
									{
										Exception e("Unsupported system");
...
// ///////////// ///////////// ///////////// /////////////
   ...
   }  // End of method 'SolverPPPARMGEX::AmbiguityFixing()'
       ...
       */
   void SolverPPPARMGEX::AmbiguityUpdate( Vector<double>& state,
      ...
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverPPPARMGEX::AmbiguityUpdate()'
      ...
      // @param gData    Data object holding the data.
      //
   int SolverPPPARMGEX::MeasUpdate( const Vector<double>& prefitResiduals,
...
matrix and a priori state estimation vector do not match.");
   ...
   }  // End of method 'SolverPPPARMGEX::MeasUpdate()'
       ...
       * @param gData    Data object holding the data.
       */
   gnssRinex& SolverPPPARMGEX::postCompute( gnssRinex& gData )
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverPPPARMGEX::postCompute()'
       ...
       *
       */
   SolverPPPARMGEX& SolverPPPARMGEX::setNEU( bool useNEU )
   {

         //> Firstly, let's clear all the set that storing the variable types.
         //> or else, SolverPPPARMGEXFB will throw error!
   ...
   }  // End of method 'SolverPPPARMGEX::setNEU()'
       ...
       */
   SolverPPPARMGEX& SolverPPPARMGEX::setCoordinatesModel( StochasticModel* pModel )
   {
   ...
   }  // End of method 'SolverPPPARMGEX::setCoordinatesModel()'
       ...
       */
   double SolverPPPARMGEX::getSolution(const TypeID& type) const
      throw(InvalidRequest)
   {
   ...
   }  // End of method 'SolverPPPARMGEX::getSolution()'
       ...
       */
   double SolverPPPARMGEX::getVariance(const TypeID& type) const
      throw(InvalidRequest)
   {
   ...
   }  // End of method 'SolverPPPARMGEX::getVariance()'


      /** Return the CURRENT number of satellite.
       */
   int SolverPPPARMGEX::getCurrentSatNumber() const
      throw(InvalidRequest)
   {
      ...
      /** Return the CURRENT number of satellite.
       */
   int SolverPPPARMGEX::getFixedAmbNumL1() const
      throw(InvalidRequest)
   {
         // Return current fixed satellite number
      return numFixedBL1;
      ...
      /** Return the CURRENT number of satellite.
       */
   int SolverPPPARMGEX::getFixedAmbNumWL() const
      throw(InvalidRequest)
   {
         // Return current fixed satellite number
      return numFixedBWL;
      ...
      /** Return the CURRENT number of satellite.
       */
   bool SolverPPPARMGEX::getConverged() const
      throw(InvalidRequest)
   {
         // Return current fixed satellite number
      return converged;
