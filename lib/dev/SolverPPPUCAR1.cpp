#pragma ident "$Id: SolverPPPUCAR1.cpp 2645 2012-11-05 03:23:24Z shjzhang $"

/**
 * @file SolverPPPUCAR1.cpp
...
namespace gpstk
{
   ...
   int SolverPPPUCAR1::classIndex = 9300000;

      // Debug level for print out information
   int SolverPPPUCAR1::debugLevel = 0;

      // Returns an index identifying this object.
   int SolverPPPUCAR1::getIndex() const
   { return index; }


      // Returns a string identifying this object.
   std::string SolverPPPUCAR1::getClassName() const
   { return "SolverPPPUCAR1"; }
       ...
       */
   SolverPPPUCAR1::SolverPPPUCAR1(bool useNEU, int polyOrder)
   ...
   }  // End of 'SolverPPPUCAR1::SolverPPPUCAR1()'


      // Initializing method.
   void SolverPPPUCAR1::Init(void)
   {
...
//      pUPDStoModelL2 = &updModelL2;
   ...
   }  // End of method 'SolverPPPUCAR1::Init()'
       ...
       */
   gnssSatTypeValue& SolverPPPUCAR1::Process(gnssSatTypeValue& gData)
      throw(ProcessingException, SVNumException)
   {
   ...
   }  // End of method 'SolverPPPUCAR1::Process()'
       ...
       * @param gData     Data object holding the data.
       */
   gnssRinex& SolverPPPUCAR1::Process(gnssRinex& gData)
      throw(ProcessingException, SVNumException)
   {
       ...
       * @param gData    Data object holding the data.
       */
   gnssRinex& SolverPPPUCAR1::preCompute( gnssRinex& gData )
      throw(ProcessingException, SVNumException)
   {
...
//				// Debug code ^^^
            ...
            initialErrorCovariance(5,5) = 1;
					...
					// receiver clock of L1 and L2 signal
...
//            cout << "timeOffset" << timeOffset << endl;
   ...
   }  // End of method 'SolverPPPUCAR1::preCompute()'
      ...
      //
   gnssRinex& SolverPPPUCAR1::Compute( gnssRinex& gData )
      throw(InvalidSolver)
   {
   ...
   }  // End of method 'SolverPPPUCAR1::Compute()'
      ...
      // @param gData    Data object holding the data.
      //
   int SolverPPPUCAR1::TimeUpdate( const Matrix<double>& phiMatrix,
...
of qMatrix");
   ...
   }  // End of method 'SolverPPPUCAR1::TimeUpdate()'


   gnssRinex& SolverPPPUCAR1::AmbiguityConstr( gnssRinex& gData )
   ...
   }  // End of method 'SolverPPPUCAR1::AmbiguityConstr()'



      // Now, fix all the ambiguities to integers 
   gnssRinex& SolverPPPUCAR1::AmbiguityFixing( gnssRinex& gData )
      throw(ProcessingException)
   {
...
//         cout << "newState" << newState << endl;
   ...
   }  // End of method 'SolverPPPUCAR1::AmbiguityFixing()'
       ...
       */
   void SolverPPPUCAR1::AmbiguityUpdate( Vector<double>& state,
      ...
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverPPPUCAR1::AmbiguityUpdate()'
      ...
      // @param gData    Data object holding the data.
      //
   int SolverPPPUCAR1::MeasUpdate( const Vector<double>& prefitResiduals,
...
matrix and a priori state estimation vector do not match.");
   ...
   }  // End of method 'SolverPPPUCAR1::MeasUpdate()'
       ...
       * @param gData    Data object holding the data.
       */
   gnssRinex& SolverPPPUCAR1::postCompute( gnssRinex& gData )
      throw(ProcessingException)
   {
   ...
   }  // End of method 'SolverPPPUCAR1::postCompute()'
       ...
       *
       */
   SolverPPPUCAR1& SolverPPPUCAR1::setNEU( bool useNEU, int polyOrder )
   {
         //
...
//      srcIndexedTypes.push_back(TypeID::updL2);  // #8
      srcIndexedTypes.push_back(TypeID::cdtL1);  // #7  
      srcIndexedTypes.push_back(TypeID::cdtL2);  // #8
   ...
   }  // End of method 'SolverPPPUCAR1::setNEU()'
       ...
       */
   SolverPPPUCAR1& SolverPPPUCAR1::setCoordinatesModel( StochasticModel* pModel )
   {
   ...
   }  // End of method 'SolverPPPUCAR1::setCoordinatesModel()'
       ...
       *                    ionospheric delays.
       */
   SolverPPPUCAR1& SolverPPPUCAR1::setIonosphericModel(StochasticModel* pModel)
   {
         // All coordinates will have the same model
      pIonoModel = pModel;
      return (*this);
       ...
       */
   double SolverPPPUCAR1::getSolution(const TypeID& type) const
...
//      it = defaultEqDef.body.find(type);
   ...
   }  // End of method 'SolverPPPUCAR1::getSolution()'
       ...
       * @param type    TypeID of the solution we are looking for.
       */
   double SolverPPPUCAR1::getFixedSolution(const TypeID& type) const
      throw(InvalidRequest)
   {
...
//      TypeIDSet::const_iterator it2;
       ...
       */
   double SolverPPPUCAR1::getVariance(const TypeID& type) const
      throw(InvalidRequest)
   {
...
//      TypeIDSet::const_iterator it2;
   ...
   }  // End of method 'SolverPPPUCAR1::getVariance()'
       ...
       * @param type    TypeID of the variance we are looking for.
       */
   double SolverPPPUCAR1::getFixedVariance(const TypeID& type) const
      throw(InvalidRequest)
   {
...
//      TypeIDSet::const_iterator it2;
   ...
   }  // End of method 'SolverPPPUCAR1::getFixedVariance()'



      /** Return the CURRENT number of satellite.
       */
   int SolverPPPUCAR1::getCurrentSatNumber() const
      throw(InvalidRequest)
   {
      ...
      /** Return the CURRENT number of satellite.
       */
   int SolverPPPUCAR1::getFixedAmbNumWL() const
      throw(InvalidRequest)
   {
         // Return current fixed satellite number
      return numFixedBWL;
      ...
      /** Return the CURRENT number of satellite.
       */
   int SolverPPPUCAR1::getFixedAmbNumL1() const
      throw(InvalidRequest)
   {
         // Return current fixed satellite number
      return numFixedBL1;
