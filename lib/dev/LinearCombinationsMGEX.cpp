...
namespace gpstk
{
   ...
   LinearCombinationsMGEX::LinearCombinationsMGEX()
   {
      ...
      l2Prefit.body[TypeID::corrL2]       = -1.0;
		   ...
		   // Definition to compute prefit residual of P1
      p1PrefitGPS.header                     = TypeID::prefitP1;
      p1PrefitGPS.body[TypeID::P1]           = +1.0;
      p1PrefitGPS.body[TypeID::rho]          = -1.0;
      p1PrefitGPS.body[TypeID::dtSat]        = +1.0;
      p1PrefitGPS.body[TypeID::rel]          = -1.0;
      p1PrefitGPS.body[TypeID::gravDelay]    = -1.0;
      p1PrefitGPS.body[TypeID::satPCenter]   = -1.0;
      p1PrefitGPS.body[TypeID::tropoSlant]   = -1.0;
         // Differential code biases (DCBs) for P1-P2
      p1PrefitGPS.body[TypeID::instP1]       = -1.0;
         // Interpolated from reference stations
      p1PrefitGPS.body[TypeID::corrP1]       = -1.0;
    


         // Definition to compute prefit residual of P2
      p2PrefitGPS.header                     = TypeID::prefitP2;
      p2PrefitGPS.body[TypeID::P2]           = +1.0;
      p2PrefitGPS.body[TypeID::rho]          = -1.0;
      p2PrefitGPS.body[TypeID::dtSat]        = +1.0;
      p2PrefitGPS.body[TypeID::rel]          = -1.0;
      p2PrefitGPS.body[TypeID::gravDelay]    = -1.0;
      p2PrefitGPS.body[TypeID::satPCenter]   = -1.0;
      p2PrefitGPS.body[TypeID::tropoSlant]   = -1.0;
         // Differential code biases (DCBs) for P1-P2
      p2PrefitGPS.body[TypeID::instP2]       = -1.0;
         // Interpolated from reference stations
      p2PrefitGPS.body[TypeID::corrP2]       = -1.0;


         // Definition to compute prefit residual of L1
      l1PrefitGPS.header                     = TypeID::prefitL1;
      l1PrefitGPS.body[TypeID::L1]           = +1.0;
      l1PrefitGPS.body[TypeID::rho]          = -1.0;
      l1PrefitGPS.body[TypeID::dtSat]        = +1.0;
      l1PrefitGPS.body[TypeID::updSatL1]     = +1.0;
      l1PrefitGPS.body[TypeID::rel]          = -1.0;
      l1PrefitGPS.body[TypeID::gravDelay]    = -1.0;
      l1PrefitGPS.body[TypeID::satPCenter]   = -1.0;
      l1PrefitGPS.body[TypeID::tropoSlant]   = -1.0;
         // Coefficient for L1 windUp is L1 wavelength/2*PI
      l1PrefitGPS.body[TypeID::windUp]       = -L1_WAVELENGTH_GPS/TWO_PI;
         // Interpolated from reference stations
      l1PrefitGPS.body[TypeID::corrL1]       = -1.0;


         // Definition to compute prefit residual of L2
      l2PrefitGPS.header                     = TypeID::prefitL2;
      l2PrefitGPS.body[TypeID::L2]           = +1.0;
      l2PrefitGPS.body[TypeID::rho]          = -1.0;
      l2PrefitGPS.body[TypeID::dtSat]        = +1.0;
      l2PrefitGPS.body[TypeID::updSatL2]     = +1.0;
      l2PrefitGPS.body[TypeID::rel]          = -1.0;
      l2PrefitGPS.body[TypeID::gravDelay]    = -1.0;
      l2PrefitGPS.body[TypeID::satPCenter]   = -1.0;
      l2PrefitGPS.body[TypeID::tropoSlant]   = -1.0;
         // Coefficient for L2 windUp is L2 wavelength/2*PI
      l2PrefitGPS.body[TypeID::windUp]       = -L2_WAVELENGTH_GPS/TWO_PI;
         // Interpolated from reference stations
      l2PrefitGPS.body[TypeID::corrL2]       = -1.0;
...
//    pdeltaPrefit.body[TypeID::instPdelta]   = -1.0;
         ...
         // Definition to compute prefit residual of Pdelta (LW)
      pdeltaPrefitGPS.header                     = TypeID::prefitPdelta;
      pdeltaPrefitGPS.body[TypeID::Pdelta]       = +1.0;
      pdeltaPrefitGPS.body[TypeID::rho]          = -1.0;
      pdeltaPrefitGPS.body[TypeID::dtSat]        = +1.0;
      pdeltaPrefitGPS.body[TypeID::rel]          = -1.0;
      pdeltaPrefitGPS.body[TypeID::gravDelay]    = -1.0;
      pdeltaPrefitGPS.body[TypeID::satPCenter]   = -1.0;
      pdeltaPrefitGPS.body[TypeID::tropoSlant]   = -1.0;

         // Computed from the reference stations
      pdeltaPrefitGPS.body[TypeID::corrPdelta]   = -1.0;
      ...
      ldeltaPrefit.body[TypeID::corrLdelta]   = -1.0;
         ...
         // Definition to compute prefit residual of Ldelta (LW)
      ldeltaPrefitGPS.header                     = TypeID::prefitLdelta;
      ldeltaPrefitGPS.body[TypeID::Ldelta]       = +1.0;
      ldeltaPrefitGPS.body[TypeID::rho]          = -1.0;
      ldeltaPrefitGPS.body[TypeID::dtSat]        = +1.0;
      ldeltaPrefitGPS.body[TypeID::updSatWL]     = +1.0;
      ldeltaPrefitGPS.body[TypeID::rel]          = -1.0;
      ldeltaPrefitGPS.body[TypeID::gravDelay]    = -1.0;
      ldeltaPrefitGPS.body[TypeID::satPCenter]   = -1.0;
      ldeltaPrefitGPS.body[TypeID::tropoSlant]   = -1.0;

         // Computed from reference stations
      ldeltaPrefitGPS.body[TypeID::corrLdelta]   = -1.0;
...
//    mwubbenaPrefit.body[TypeID::instMWubbena] = -1.0;  // DCB for MWubbena
      mwubbenaPrefit.body[TypeID::updSatMW]     = +1.0;  // UPD for MWubbena
         ...
         // Definition to compute the prefit residual of Melbourne-Wubbena (W) 
         // combination
      mwubbenaPrefitGPS.header           = TypeID::prefitMWubbena;
      mwubbenaPrefitGPS.body[TypeID::MWubbena]     = +1.0;
//    mwubbenaPrefit.body[TypeID::instMWubbena] = -1.0;  // DCB for MWubbena
      mwubbenaPrefitGPS.body[TypeID::updSatMW]     = +1.0;  // UPD for MWubbena

         // Definition to compute the prefit residual of Melbourne-Wubbena (W) 
         // combination
			// For Galileo system
      mwubbenaPrefitGalileo.header           = TypeID::prefitMWubbena;
      mwubbenaPrefitGalileo.body[TypeID::MWubbena]     = +1.0;
//    mwubbenaPrefit.body[TypeID::instMWubbena] = -1.0;  // DCB for MWubbena
      mwubbenaPrefitGalileo.body[TypeID::updSatMW]     = +1.0;  // UPD for MWubbena
