...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverPPPMGEX object
       *   SolverPPPMGEX pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPPMGEX" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverPPPMGEX" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPPMGEX" object will
       ...
       *
       *
       * \warning "SolverPPPMGEX" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPPMGEX : public CodeKalmanSolver
   {
   public:
      ...
      virtual gnssRinex& Process(gnssRinex& gData)
          ...
          *
          */
      virtual SolverPPPMGEX& Reset( const Vector<double>& newState,
      ...
      { return std::sqrt(weightFactor); };
          ...
          */
      virtual SolverPPPMGEX& setWeightFactor(double factor)
      ...
      { return pCoordXStoModel; };
          ...
          */
      SolverPPPMGEX& setXCoordinatesModel(StochasticModel* pModel)
      ...
      { return pCoordYStoModel; };
          ...
          */
      SolverPPPMGEX& setYCoordinatesModel(StochasticModel* pModel)
      ...
      { return pCoordZStoModel; };
          ...
          *                    dz (or dH) coordinate.
          */
      SolverPPPMGEX& setZCoordinatesModel(StochasticModel* pModel)
      { pCoordZStoModel = pModel; return (*this); };
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverPPPMGEX& setCoordinatesModel(StochasticModel* pModel);
      ...
      { return pTropoStoModel; };
          ...
          * solver objects.
          */
      virtual SolverPPPMGEX& setTroposphereModel(StochasticModel* pModel)
      ...
      { return pClockStoModel; };
          ...
          * solver objects.
          */
      virtual SolverPPPMGEX& setReceiverClockModel(StochasticModel* pModel)
      ...
      { return pBiasStoModel; };
          ...
          */
      virtual SolverPPPMGEX& setPhaseBiasesModel(StochasticModel* pModel)
      ...
      { return phiMatrix; };
          ...
          *
          */
      virtual SolverPPPMGEX& setPhiMatrix(const Matrix<double> & pMatrix)
      ...
      { return qMatrix; };
          ...
          *
          */
      virtual SolverPPPMGEX& setQMatrix(const Matrix<double> & pMatrix)
