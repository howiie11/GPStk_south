#pragma ident "$Id: SolverPPPARMGEX.hpp 2645 2011-06-08 03:23:24Z shjzhang $"

/**
 * @file SolverPPPARMGEX.hpp
 * Class to compute the PPP Solution using MW/LC observations.
 */

#ifndef GPSTK_SOLVERPPPARMGEX_HPP
#define GPSTK_SOLVERPPPARMGEX_HPP
...
namespace gpstk
{
       ...
       *
       *      // Declare a SolverPPPARMGEX object
       *   SolverPPPARMGEX pppSolver;
       *
       *     // PROCESSING PART
       *
       *   gnssRinex gRin;
       ...
       * @endcode
       *
       * The "SolverPPPARMGEX" object will extract all the data it needs from the
       ...
       *
       * In any case, the "SolverPPPARMGEX" object will also automatically add and
       ...
       *
       * If these weights are not assigned, then the "SolverPPPARMGEX" object will
       ...
       *
       *
       * \warning "SolverPPPARMGEX" is based on a Kalman filter, and Kalman filters
       ...
       *
       */
   class SolverPPPARMGEX : public CodeKalmanSolver
   {
   public:
          ...
          */
      SolverPPPARMGEX(bool useNEU = false);
      ...
      virtual void AmbiguityUpdate(Vector<double>& state,
          ...
          *
          */
      virtual SolverPPPARMGEX& setNEU( bool useNEU );
          ...
          * 'StochasticModel' (constant coordinates) or 'WhiteNoiseModel'.
          */
      virtual SolverPPPARMGEX& setCoordinatesModel(StochasticModel* pModel);
          ...
          */
      virtual SolverPPPARMGEX& setRestartInterval(double interval)
      {
          ...
          * @param interval    interval that restart the filter.
          */
      virtual SolverPPPARMGEX& setReInitialize(bool reInit)
      {
         reInitialize = reInit;
         return (*this);
      };
          ...
          */
      virtual SolverPPPARMGEX& setARMethod(string ambMethod)
      {
         ARMethod = ambMethod;
         return (*this);
      };
			 ...
			 * @param interval    interval that restart the filter.
			 */ 
		virtual SolverPPPARMGEX& setPrecisionStandard( double  standard )
		{
      ...
      virtual int getFixedAmbNumL1() const
         throw(InvalidRequest);
           ...
           */
      virtual SolverPPPARMGEX& setBufferSize(int size )
   ...
   private:
      ...
      virtual SolverPPPARMGEX& setDefaultEqDefinition(
                             const gnssEquationDefinition& eqDef )
      { return (*this); };



   }; // End of class 'SolverPPPARMGEX'
